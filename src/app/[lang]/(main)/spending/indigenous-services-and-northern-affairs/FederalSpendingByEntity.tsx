...
const data = [
  ...
  { name: "Department of Crown-Indigenous Relations and Northern Affairs", value: 16.35 },
  { name: "Federal Economic Development Agency for Northern Ontario", value: 0.07 },
